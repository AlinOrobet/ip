...
function PlayerPage({player, header}) {
  return (
    <div
      className={`${header} text-white relative overflow-hidden bg-no-repeat bg-cover bg-center bg-gradient-to-t from-white via-blue-500 to-blue-900`}
    >
      <div
        ...
        <div className="flex items-center justify-center mx-3 mt-10">
          <div>
            ...
            <p className="text-gray-400 mt-4 lg:text-xl">
              Lorem ipsum dolor sit, amet consectetur adipisicing elit. Dolorem adipisci quidem est
              eos, voluptas esse voluptates enim obcaecati architecto quisquam, quasi aliquam iure
              nihil nesciunt deserunt harum autem qui! Soluta.
            </p>
          </div>
        </div>
      </div>
