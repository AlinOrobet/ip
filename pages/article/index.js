  ...
  return (
    <article>
      <section className="flex flex-col lg:flex-row pb-24 px-0 lg:px-10">
        ...
        />
        <div className="px-10">
          <h1 className="headerTitle px-0 no-underline pb-2">{data[0].title}</h1>
          <div className="flex divide-x-2 space-x-4">
            <h2 className="font-bold">By : {data[0].author}</h2>
            <h2 className="font-bold pl-4">Source : {data[0].source}</h2>
            <p className="pl-4">{data[0].date}</p>
          </div>
          <p className="pt-4">{data[0].description}</p>
        </div>
      </section>
    </article>
  );
